...
# from backend.backendapp import app  <--- IS LINE KO HATA DIYA GAYA HAI
import os

# --- Flask App Initialization (Sirf ek baar) ---
app = Flask(__name__, static_folder="frontend")

# Duplicate app = Flask(__name__, static_folder="frontend", template_folder="frontend") hata diya gaya hai
# Duplicate app = Flask(__name__) hata diya gaya hai
